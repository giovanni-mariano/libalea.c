...
int alea_wasm_set_picking_enabled(int enabled);
const char* alea_wasm_version(void);
...
int alea_wasm_pick(int x, int y);
int alea_wasm_pick_cell_id(void);
int alea_wasm_pick_material_id(void);
double alea_wasm_pick_depth(void);
