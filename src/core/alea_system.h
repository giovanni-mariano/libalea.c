 ...
 * remain lock-free because language bindings may store it from a signal
 * handler while OpenMP workers read it. */
extern atomic_int g_alea_interrupted;

static inline bool alea_interrupted_internal(void) {
