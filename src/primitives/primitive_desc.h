...
/* Resolve the three RHP facet-center vectors.  MCNP's regular-hex short form
 * supplies only r1; in that case r2/r3 are generated by +/-60 degree rotations
 * about the prism axis. */
